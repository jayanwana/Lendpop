...
var Form3 = function Form3(_ref4) {
  ...
  return __jsx(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_16__["default"], {
    ...
    label: "Expiry Date",
    name: "expDate",
    minDate: new Date("".concat(date.getFullYear(), "-").concat(date.getMonth(), "-1")),
    maxDate: new Date("".concat(date.getFullYear() + 3, "-").concat(date.getMonth(), "-1")),
    value: expDate,
